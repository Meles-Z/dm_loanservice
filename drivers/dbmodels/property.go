...
type Property struct {
	...
	Valuation    types.NullDecimal `boil:"valuation" json:"valuation,omitempty" toml:"valuation" yaml:"valuation,omitempty"`
	SizeSQFT     null.Int          `boil:"size_sqft" json:"size_sqft,omitempty" toml:"size_sqft" yaml:"size_sqft,omitempty"`
	YearBuilt    null.Int          `boil:"year_built" json:"year_built,omitempty" toml:"year_built" yaml:"year_built,omitempty"`
...
var PropertyWhere = struct {
	...
	Valuation    whereHelpertypes_NullDecimal
	SizeSQFT     whereHelpernull_Int
	YearBuilt    whereHelpernull_Int
	CreatedAt    whereHelpernull_Time
	UpdatedAt    whereHelpernull_Time
}{
	ID:           whereHelperstring{field: "\"property\".\"id\""},
	Address:      whereHelperstring{field: "\"property\".\"address\""},
	PropertyType: whereHelpernull_String{field: "\"property\".\"property_type\""},
	Region:       whereHelpernull_String{field: "\"property\".\"region\""},
	Valuation:    whereHelpertypes_NullDecimal{field: "\"property\".\"valuation\""},
	SizeSQFT:     whereHelpernull_Int{field: "\"property\".\"size_sqft\""},
	YearBuilt:    whereHelpernull_Int{field: "\"property\".\"year_built\""},
	CreatedAt:    whereHelpernull_Time{field: "\"property\".\"created_at\""},
	UpdatedAt:    whereHelpernull_Time{field: "\"property\".\"updated_at\""},
}
...
func (o *Property) GetCollaterals() CollateralSlice {
	if o == nil {
		return nil
	}
...
func (r *propertyR) GetCollaterals() CollateralSlice {
	if r == nil {
		return nil
	}
...
var (
	propertyAllColumns            = []string{"id", "address", "property_type", "region", "valuation", "size_sqft", "year_built", "created_at", "updated_at"}
	propertyColumnsWithoutDefault = []string{"id", "address"}
	propertyColumnsWithDefault    = []string{"property_type", "region", "valuation", "size_sqft", "year_built", "created_at", "updated_at"}
...
func (q propertyQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Property, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbmodels: failed to execute a one query for property")
	}
...
func (q propertyQuery) All(ctx context.Context, exec boil.ContextExecutor) (PropertySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbmodels: failed to assign all query results to Property slice")
	}
...
func (q propertyQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to count property rows")
	}
...
func (q propertyQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbmodels: failed to check if property exists")
	}
...
func (o *Property) Collaterals(mods ...qm.QueryMod) collateralQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"collaterals\".\"property_id\"=?", o.ID),
	)
...
func (propertyL) LoadCollaterals(ctx context.Context, e boil.ContextExecutor, singular bool, maybeProperty interface{}, mods queries.Applicator) error {
	var slice []*Property
	var object *Property
	...
	query := NewQuery(
		qm.From(`collaterals`),
		qm.WhereIn(`collaterals.property_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Property) AddCollaterals(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Collateral) error {
	var err error
...
func Properties(mods ...qm.QueryMod) propertyQuery {
	mods = append(mods, qm.From("\"property\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"property\".*"})
	}
...
func FindProperty(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Property, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"property\" where \"id\"=$1", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbmodels: unable to select from property")
	}
...
func (o *Property) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbmodels: no property provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"property\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"property\" %sDEFAULT VALUES%s"
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to insert into property")
	}
...
func (o *Property) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbmodels: unable to update property, could not build whitelist")
		}

		cache.query = fmt.Sprintf("UPDATE \"property\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update property row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by update for property")
	}
...
func (q propertyQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update all for property")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to retrieve rows affected for property")
	}
...
func (o PropertySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"property\" SET %s WHERE %s",
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update all in property slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to retrieve rows affected all in update all property")
	}
	return rowsAff, nil
}
...
func (o *Property) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("dbmodels: no property provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("dbmodels: unable to upsert property, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(propertyPrimaryKeyColumns) == 0 {
				return errors.New("dbmodels: unable to upsert property, could not build conflict column list")
			}

			conflict = make([]string, len(propertyPrimaryKeyColumns))
			copy(conflict, propertyPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"property\"", updateOnConflict, ret, update, conflict, insert, opts...)
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to upsert property")
	}
...
func (o *Property) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbmodels: no Property provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete from property")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by delete for property")
	}
...
func (q propertyQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbmodels: no propertyQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete all from property")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by deleteall for property")
	}
...
func (o PropertySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete all from property slice")
	}
...
func (o *PropertySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"property\".* FROM \"property\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, propertyPrimaryKeyColumns, len(*o))
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to reload all in PropertySlice")
	}
...
func PropertyExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"property\" where \"id\"=$1 limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbmodels: unable to check if property exists")
	}
